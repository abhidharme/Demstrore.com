...
var changename = JSON.parse(localStorage.getItem('signupDatabase'));

changename.map(function(e){
    var msg = document.createElement('h4');
    msg.textContent = e.fullname;

    document.querySelector('#changename').append(msg)
})

var logout = document.querySelector('#logoutbut').addEventListener('click', Logout);
